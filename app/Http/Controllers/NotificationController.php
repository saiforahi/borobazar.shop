...
class NotificationController extends Controller
{
    ...
    public function markNotificationAsRead($notification_id,$size){
        ...
        ->first();
        return response()->json(['blood_request'=>$blood_request,'notifications'=>$result,'total_unread'=>Auth::user()->unreadNotifications->where('type','App\\Notifications\\BloodRequestNotification')->count()]) ;
    }
}
